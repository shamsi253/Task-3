...
?>
            ...
            <?php
$sql1 = "SELECT phone FROM users ORDER BY id DESC
LIMIT 1";
...
?>
            ...
            <i class="fa fa-envelope-square">
                <?php
$sql1 = "SELECT email FROM users ORDER BY id DESC
LIMIT 1";
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
	// output data of each row
...
?>
            ...
            <?php
$sql1 = "SELECT place FROM users ORDER BY id DESC
LIMIT 1";
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
	// output data of each row
...
<?php
$sql1 = "SELECT designation FROM users ORDER BY id DESC
LIMIT 1";
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
	// output data of each row
...
?>
            <br>
            <i class="fa fa-calendar z"></i>
               <?php
$sql1 = "SELECT dob FROM users ORDER BY id DESC
LIMIT 1";
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
	// output data of each row
...
?>
        ...
        <div class="col-9 ">
            ...
            <div class="shad">
                <p> <?php
$sql1 = "SELECT objective FROM users ORDER BY id DESC
LIMIT 1";
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
	// output data of each row
...
?>
            ...
            <div class="shad">
                <p class="font">
                    <?php
$sql = "SELECT qualification,mark,year,university FROM education ORDER BY id DESC
LIMIT 1";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
	echo "<table><tr><th>Qualification</th><th>Mark</th><th>University</th><th>Year</th></tr>";
	while ($row = $result->fetch_assoc()) {
		echo "<tr><td>" . $row["qualification"] . "</td><td>" . $row["mark"] . "</td><td> "
			. $row["university"] . "</td><td>" . $row["year"] . "</td></tr>";
	}
	echo "</table>";
} else {
	echo "0 results";
...
if ($result->num_rows > 0) {
	// output data of each row
	while ($row = $result->fetch_assoc()) {
		echo "<li>" . $row["technical_skills"] . "</li>";
	}
} else {
	echo "0 results";
}
...
if ($result->num_rows > 0) {
	// output data of each row
	while ($row = $result->fetch_assoc()) {
		echo "<li>" . $row["personal_skills"] . "</li>";
	}
} else {
	echo "0 results";
}
